...
export function Hero() {
  const [imgSrc, setImgSrc] = useState(PERSONAL_INFO.portraitLocal);
  ...
  return (
    <section
      id="home"
      className="relative min-h-[90vh] flex items-center pt-28 pb-16 lg:pt-36 lg:pb-24 bg-[#0A0A0A] overflow-hidden"
    >
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          {/* Left Column: Welcome Heading & Pill Badge (Exact Canva layout) */}
          <motion.div
          ...
          >
            <div className="space-y-4">
              <h1 className="font-serif-display text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-normal tracking-tight text-white leading-[1.08]">
                Welcome to <br />
                <span className="italic font-editorial-italic font-normal">My Developer</span> <br />
                Portfolio
              </h1>
            </div>

            {/* Pill Badge (matching "Chad Gibbons / Graphic Designer" in the Canva video) */}
            <motion.div
            ...
            >
              ...
              <span className="text-xs sm:text-sm font-medium tracking-wide text-white uppercase">
                {PERSONAL_INFO.name} / Full Stack & AI Developer
              </span>
            </motion.div>

            {/* Brief introductory quote */}
          ...
          {/* Right Column: Architectural Arch Portrait & Circular "Work with me today" Badge */}
          <motion.div
          ...
          >
            <div className="relative w-full max-w-[340px] sm:max-w-[380px]">
              ...
              {/* The Iconic Architectural Arch Frame (Tombstone curve from Canva template) */}
              <div className="relative w-full aspect-[3/4] arch-hero-portrait bg-[#161616] border border-[#2E2E2E] overflow-hidden shadow-2xl group">
                <img
                  src={imgSrc}
                  alt={PERSONAL_INFO.fullName}
                  onError={() => setImgSrc(PERSONAL_INFO.portraitFallback)}
              ...
              {/* Floating "Work with me today ↗" Circular Badge (as seen in the Canva video) */}
              <motion.button
                type="button"
                onClick={scrollToContact}
